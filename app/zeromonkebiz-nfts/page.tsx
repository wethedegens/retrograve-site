...
const ZEROMONKEBIZ_BG_IMAGE = "/zeromonkebiz-bg-nfts.png";
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const collection = ZEROMONKEBIZ_COLLECTION_ID.trim();
        ...
        if (!cancelled) {
          setError(e?.message || "Failed to load ZeroMonkeBiz NFTs");
          setItems([]);
        }
      } finally {
  ...
  return (
    <main
      style={{
        ...
        padding: "18px 0 80px",
        paddingTop: 64,
        backgroundImage: `url(${ZEROMONKEBIZ_BG_IMAGE})`,
        ...
        {!connected ? (
          ...
          >
            ...
            >
              ...
              >
                ...
                to open it in the locker and export wallpapers.
              </p>
          ...
          <>
            ...
            <p style={{ margin: 0, opacity: 0.75, color: "rgba(255,255,255,0.85)" }}>
              Showing ZeroMonkeBiz NFTs owned by your connected wallet.
            </p>
            ...
            {!loading && !error && items.length === 0 && (
              <p style={{ opacity: 0.85 }}>No ZeroMonkeBiz NFTs found.</p>
            )}
            ...
            {!loading && !error && items.length > 0 && (
              <NftGrid
                ...
                onPick={(nft) => {
                  ...
                  router.push(
                    `/locker?mint=${mint}${uri ? `&uri=${uri}` : ""}&project=zeromonkebiz`
                  );
                }}
              />
            )}
