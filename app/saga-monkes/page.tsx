...
export default function SagaMonkesLandingPage() {
  const previewImages = [
    "/demo/saga-monke-1.png",
    "/demo/saga-monke-2.png",
    "/demo/saga-monke-3.png",
  ];
    ...
    <main className="lp-wrap">
      <section className="lp-inner">
        ...
        <div className="lp-left">
          <h1 className="lp-title">SAGAMONKES</h1>
          ...
          <p className="lp-copy">
            ...
            SagaMonkes.
            <br />
            Connect your wallet, pick a SagaMonke, swap backgrounds, and export
            for any device.
          </p>
      ...
      <style jsx>{`
        .lp-wrap {
          ...
          padding-top: 64px;
          background-image: url("/saga-monkes-bg.jpg");
